...
document.getElementById('column1').innerHTML = "<h3>Hello there.</h3> <p>Nice to meet you.</p>";
document.getElementById('column1').innerHTML += "Bonjour, mon ami.";
...
document.getElementById("column2").style.backgroundColor = "#70CF70FF"
//LOGIC!
...
if(animal = "minotaur"){
    ...
    console.log("You go for a nice swim")
}
...
if(weapon == "Fists"){
    document.getElementById("column3").innerHTML += "<p>You use Furry of Fists!</p>";
}else if(weapon == "Ink Blots"){
    document.getElementById("column3").innerHTML += "<p>You fire Ink Blots at your opponent!</p>";
}else{
    document.getElementById("column3").innerHTML += "<p>You do nothing...</p>";
}
